...
"[project]/src/utils/id-utils.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/opportunity-service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$id$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/id-utils.ts [app-ssr] (ecmascript)");
;
;
;
...
const OpportunityService = {
   ...
   */ getOpportunities: async (params)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : 'Failed to fetch opportunities');
            return {
                opportunities: [],
                total: 0
            };
   ...
   */ getOpportunity: async (id)=>{
        try {
            ...
            const normalizedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$id$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeId"])(data);
            console.log('Opportunity data with consistent ID:', normalizedData);
            return normalizedData;
        } catch (error) {
            console.error(`Error fetching opportunity ${id}:`, error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : 'Failed to fetch opportunity');
            throw error;
        }
    },
    /**
   ...
   */ createOpportunity: async (opportunityData)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : 'Failed to create opportunity');
            throw error;
        }
    },
    /**
   ...
   */ updateOpportunity: async (id, opportunityData)=>{
        try {
            ...
            const data = await response.json();
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Opportunity updated successfully');
            return data;
        } catch (error) {
            console.error(`Error updating opportunity ${id}:`, error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : 'Failed to update opportunity');
            throw error;
        }
    },
    /**
   ...
   */ deleteOpportunity: async (id)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : 'Failed to delete opportunity');
            throw error;
        }
    },
    /**
   ...
   */ changeOpportunityStage: async (id, stage)=>{
        try {
            ...
            const data = await response.json();
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Opportunity stage updated to ${stage}`);
            return data;
        } catch (error) {
            console.error(`Error updating opportunity stage ${id}:`, error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : 'Failed to update opportunity stage');
            throw error;
        }
    },
    /**
   ...
   */ assignOpportunity: async (id, userId)=>{
        try {
            ...
            const data = await response.json();
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Opportunity assigned successfully');
            return data;
        } catch (error) {
            console.error(`Error assigning opportunity ${id}:`, error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : 'Failed to assign opportunity');
            throw error;
        }
    },
    /**
   ...
   */ convertLeadToOpportunity: async (leadId, opportunityData)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Lead converted to opportunity successfully');
            return normalizedData;
        } catch (error) {
            console.error(`Error converting lead ${leadId} to opportunity:`, error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : 'Failed to convert lead to opportunity');
            throw error;
        }
    },
    /**
   ...
   */ getOpportunityStats: async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : 'Failed to fetch opportunity statistics');
            throw error;
        }
    }
};
...
//# sourceMappingURL=src_9f1efa21._.js.map